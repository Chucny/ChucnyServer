...
> ⚠️ **IMPORTANT NOTE:** THIS SOFTWARE IS LICENSED UNDER THE GNU Affero General Public License v3.0 (AGPL-3.0).. IF YOU MODIFY, FORK, OR BUILD UPON THIS CODE, YOU ARE STRICTLY REQUIRED TO PUBLISH YOUR ENTIRE PROJECT AS OPEN SOURCE UNDER THE EXACT SAME LICENSE. YOU CANNOT KEEP YOUR CHANGES PRIVATE OR CLOSED-SOURCE.
>
